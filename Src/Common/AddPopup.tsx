...
import { addPopup, user } from "../Constant";
import CameraOpen from "./CameraOpen";
import Modal from "react-native-modal";
import Button from "./Button";
import Input from "./Input";

const AddPopup: React.FC<addPopup> = ({ isVisible, onClose, onSubmit }) => {
  ...
  return (
    <Modal isVisible={isVisible}>
      ...
      <View className="bg-cyan-50 rounded-md h-[500]">
        <View className=" h-full flex-col justify-between">
          <View className="flex flex-row justify-between items-center  w-full p-3 rounded-t-md">
            <Text className="text-lg text-green-600 font-bold" >User Details </Text>
